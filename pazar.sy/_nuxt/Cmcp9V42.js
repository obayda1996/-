    ...
    F = m({ ...G,
        ...
        setup(u) {
            const r = u,
                d = o("weight", "regular"),
                p = o("size", "1em"),
                L = o("color", "currentColor"),
                c = o("mirrored", !1),
                t = i(() => r.weight ? ? d),
                n = i(() => r.size ? ? p),
                g = i(() => r.color ? ? L),
                h = i(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : c ? "scale(-1, 1)" : void 0);
            return (s, W) => (a(), l("svg", Z({
                ...
                fill: g.value,
                transform: h.value
            }, s.$attrs), [v(s.$slots, "default"), t.value === "bold" ? (a(), l("g", y, f)) : t.value === "duotone" ? (a(), l("g", k, P)) : t.value === "fill" ? (a(), l("g", S, z)) : t.value === "light" ? (a(), l("g", C, V)) : t.value === "regular" ? (a(), l("g", b, j)) : t.value === "thin" ? (a(), l("g", E, D)) : A("", !0)], 16, w))
        }
    });
export {
    F as G
