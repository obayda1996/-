    ...
    G = c({ ...H,
        ...
        setup(u) {
            const r = u,
                ...
                s = i(() => r.size ? ? d),
                h = i(() => r.color ? ? p),
                g = i(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
            return (n, W) => (a(), e("svg", v({
                ...
                fill: h.value,
                transform: g.value
            }, n.$attrs), [M(n.$slots, "default"), t.value === "bold" ? (a(), e("g", w, k)) : t.value === "duotone" ? (a(), e("g", B, S)) : t.value === "fill" ? (a(), e("g", z, V)) : t.value === "light" ? (a(), e("g", b, $)) : t.value === "regular" ? (a(), e("g", j, U)) : t.value === "thin" ? (a(), e("g", q, F)) : A("", !0)], 16, y))
        }
    });
export {
    G as H
