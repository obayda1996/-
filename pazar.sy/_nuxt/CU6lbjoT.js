...
const V = ["width", "height", "fill", "transform"],
    y = {
        key: 0
    },
    H = l("path", {
    ...
    F = c({ ...G,
        ...
        setup(u) {
            const r = u,
                ...
                n = i(() => r.size ? ? p),
                m = i(() => r.color ? ? g),
                L = i(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
            return (s, W) => (e(), a("svg", M({
                ...
                fill: m.value,
                transform: L.value
            }, s.$attrs), [Z(s.$slots, "default"), t.value === "bold" ? (e(), a("g", y, w)) : t.value === "duotone" ? (e(), a("g", A, B)) : t.value === "fill" ? (e(), a("g", S, z)) : t.value === "light" ? (e(), a("g", C, P)) : t.value === "regular" ? (e(), a("g", b, j)) : t.value === "thin" ? (e(), a("g", E, D)) : v("", !0)], 16, V))
        }
    });
export {
    F as G
