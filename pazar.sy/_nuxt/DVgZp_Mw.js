    ...
    F = p({ ...G,
        ...
        setup(i) {
            const t = i,
                n = r("weight", "regular"),
                s = r("size", "1em"),
                h = r("color", "currentColor"),
                u = r("mirrored", !1),
                Z = o(() => t.weight ? ? n),
                M = o(() => t.size ? ? s),
                A = o(() => t.color ? ? h),
                d = o(() => t.mirrored !== void 0 ? t.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
            return (m, W) => (e(), a("svg", V({
                ...
                fill: A.value,
                transform: d.value
            }, m.$attrs), [v(m.$slots, "default"), Z.value === "bold" ? (e(), a("g", H, y)) : Z.value === "duotone" ? (e(), a("g", w, B)) : Z.value === "fill" ? (e(), a("g", S, z)) : Z.value === "light" ? (e(), a("g", C, b)) : Z.value === "regular" ? (e(), a("g", P, j)) : Z.value === "thin" ? (e(), a("g", E, D)) : g("", !0)], 16, c))
        }
    });
export {
    F as G
