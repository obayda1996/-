    ...
    n0 = g({ ...W,
        ...
        setup(u) {
            const r = u,
                n = L("weight", "regular"),
                s = L("size", "1em"),
                h = L("color", "currentColor"),
                m = L("mirrored", !1),
                t = o(() => r.weight ? ? n),
                A = o(() => r.size ? ? s),
                d = o(() => r.color ? ? h),
                Z = o(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
            return (i, v) => (l(), a("svg", c({
                ...
                fill: d.value,
                transform: Z.value
            }, i.$attrs), [p(i.$slots, "default"), t.value === "bold" ? (l(), a("g", q, $)) : t.value === "duotone" ? (l(), a("g", w, B)) : t.value === "fill" ? (l(), a("g", S, x)) : t.value === "light" ? (l(), a("g", z, b)) : t.value === "regular" ? (l(), a("g", C, P)) : t.value === "thin" ? (l(), a("g", j, G)) : H("", !0)], 16, M))
        }
    }),
    ...
    s0 = g({ ...i0,
        ...
        setup(u) {
            ...
            return (i, v) => (l(), a("svg", c({
                ...
                fill: d.value,
                transform: Z.value
            }, i.$attrs), [p(i.$slots, "default"), t.value === "bold" ? (l(), a("g", D, I)) : t.value === "duotone" ? (l(), a("g", J, R)) : t.value === "fill" ? (l(), a("g", T, X)) : t.value === "light" ? (l(), a("g", Y, l0)) : t.value === "regular" ? (l(), a("g", e0, r0)) : t.value === "thin" ? (l(), a("g", L0, A0)) : H("", !0)], 16, _))
        }
    });
export {
    n0 as F, s0 as G
