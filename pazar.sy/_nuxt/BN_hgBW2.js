    ...
    G = m({ ...I,
        ...
        setup(n) {
            const r = n,
                ...
                i = c(() => r.size ? ? C),
                g = c(() => r.color ? ? d),
                h = c(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
            return (s, W) => (a(), e("svg", Z({
                ...
                fill: g.value,
                transform: h.value
            }, s.$attrs), [v(s.$slots, "default"), l.value === "bold" ? (a(), e("g", w, f)) : l.value === "duotone" ? (a(), e("g", k, x)) : l.value === "fill" ? (a(), e("g", z, V)) : l.value === "light" ? (a(), e("g", b, $)) : l.value === "regular" ? (a(), e("g", j, H)) : l.value === "thin" ? (a(), e("g", q, F)) : A("", !0)], 16, M))
        }
    });
export {
    G as I
