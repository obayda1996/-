    ...
    H = g({ ...I,
        ...
        setup(c) {
            const r = c,
                ...
                i = m(() => r.size ? ? u),
                A = m(() => r.color ? ? d),
                Z = m(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
            return (s, W) => (e(), a("svg", C({
                ...
                fill: A.value,
                transform: Z.value
            }, s.$attrs), [h(s.$slots, "default"), l.value === "bold" ? (e(), a("g", w, k)) : l.value === "duotone" ? (e(), a("g", M, S)) : l.value === "fill" ? (e(), a("g", z, P)) : l.value === "light" ? (e(), a("g", V, $)) : l.value === "regular" ? (e(), a("g", j, q)) : l.value === "thin" ? (e(), a("g", D, G)) : v("", !0)], 16, y))
        }
    });
export {
    H as I
