    ...
    F = p({ ...G,
        ...
        setup(h) {
            const r = h,
                ...
                H = A(() => r.size ? ? s),
                d = A(() => r.color ? ? n),
                Z = A(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
            return (m, W) => (e(), a("svg", g({
                ...
                fill: d.value,
                transform: Z.value
            }, m.$attrs), [V(m.$slots, "default"), t.value === "bold" ? (e(), a("g", v, y)) : t.value === "duotone" ? (e(), a("g", w, B)) : t.value === "fill" ? (e(), a("g", x, S)) : t.value === "light" ? (e(), a("g", z, b)) : t.value === "regular" ? (e(), a("g", P, j)) : t.value === "thin" ? (e(), a("g", E, D)) : L("", !0)], 16, c))
        }
    });
export {
    F as G
