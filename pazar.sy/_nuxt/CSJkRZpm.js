...
const Z = ["width", "height", "fill", "transform"],
    w = {
        key: 0
    },
    y = l("path", {
    ...
    F = m({ ...G,
        ...
        setup(s) {
            const o = s,
                u = r("weight", "regular"),
                V = r("size", "1em"),
                p = r("color", "currentColor"),
                d = r("mirrored", !1),
                t = i(() => o.weight ? ? u),
                v = i(() => o.size ? ? V),
                h = i(() => o.color ? ? p),
                g = i(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : d ? "scale(-1, 1)" : void 0);
            return (n, W) => (e(), a("svg", M({
                ...
                fill: h.value,
                transform: g.value
            }, n.$attrs), [c(n.$slots, "default"), t.value === "bold" ? (e(), a("g", w, f)) : t.value === "duotone" ? (e(), a("g", k, S)) : t.value === "fill" ? (e(), a("g", x, C)) : t.value === "light" ? (e(), a("g", N, P)) : t.value === "regular" ? (e(), a("g", $, E)) : t.value === "thin" ? (e(), a("g", U, D)) : H("", !0)], 16, Z))
        }
    });
export {
    F as G
