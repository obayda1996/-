    ...
    F = v({ ...G,
        ...
        setup(u) {
            const r = u,
                ...
                i = s(() => r.size ? ? d),
                h = s(() => r.color ? ? p),
                m = s(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : g ? "scale(-1, 1)" : void 0);
            return (n, W) => (a(), e("svg", w({
                ...
                fill: h.value,
                transform: m.value
            }, n.$attrs), [Z(n.$slots, "default"), l.value === "bold" ? (a(), e("g", f, k)) : l.value === "duotone" ? (a(), e("g", C, S)) : l.value === "fill" ? (a(), e("g", z, V)) : l.value === "light" ? (a(), e("g", b, $)) : l.value === "regular" ? (a(), e("g", j, H)) : l.value === "thin" ? (a(), e("g", U, D)) : M("", !0)], 16, y))
        }
    });
export {
    F as G
