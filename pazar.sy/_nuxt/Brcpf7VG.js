    ...
    G = c({ ...H,
        ...
        setup(u) {
            const r = u,
                ...
                s = i(() => r.size ? ? m),
                g = i(() => r.color ? ? h),
                A = i(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
            return (n, W) => (a(), e("svg", L({
                ...
                fill: g.value,
                transform: A.value
            }, n.$attrs), [v(n.$slots, "default"), t.value === "bold" ? (a(), e("g", y, k)) : t.value === "duotone" ? (a(), e("g", M, x)) : t.value === "fill" ? (a(), e("g", S, N)) : t.value === "light" ? (a(), e("g", V, P)) : t.value === "regular" ? (a(), e("g", $, E)) : t.value === "thin" ? (a(), e("g", q, F)) : Z("", !0)], 16, w))
        }
    });
export {
    G as H
