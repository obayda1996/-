    ...
    F = c({ ...G,
        ...
        setup(u) {
            const r = u,
                ...
                s = i(() => r.size ? ? d),
                h = i(() => r.color ? ? p),
                L = i(() => r.mirrored !== void 0 ? r.mirrored ? "scale(-1, 1)" : void 0 : g ? "scale(-1, 1)" : void 0);
            return (n, W) => (e(), a("svg", A({
                ...
                fill: h.value,
                transform: L.value
            }, n.$attrs), [Z(n.$slots, "default"), t.value === "bold" ? (e(), a("g", y, f)) : t.value === "duotone" ? (e(), a("g", k, C)) : t.value === "fill" ? (e(), a("g", S, N)) : t.value === "light" ? (e(), a("g", V, P)) : t.value === "regular" ? (e(), a("g", $, E)) : t.value === "thin" ? (e(), a("g", X, D)) : v("", !0)], 16, M))
        }
    });
export {
    F as G
